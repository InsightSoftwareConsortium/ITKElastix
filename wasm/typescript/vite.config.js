...
export default defineConfig({
  ...
  optimizeDeps: {
    exclude: ['itk-wasm', '@itk-wasm/image-io', '@itk-wasm/transform-io', '@thewtex/zstddec', '@itk-viewer/io']
  },
  plugins: [
    ...
    viteStaticCopy({
      targets: [
        ...
        { src: '../../../node_modules/@itk-wasm/transform-io/dist/pipelines/*.{js,wasm,wasm.zst}', dest: 'pipelines', rename: { stripBase: true } },
      ],
    })
  ],
})
