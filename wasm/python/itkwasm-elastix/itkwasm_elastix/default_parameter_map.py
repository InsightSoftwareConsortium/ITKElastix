...
def default_parameter_map(
    ...
    :rtype:  Any
    """
    func = environment_dispatch("itkwasm_elastix", "default_parameter_map")
    output = func(transform_name, number_of_resolutions=number_of_resolutions, final_grid_spacing=final_grid_spacing)
    return output
